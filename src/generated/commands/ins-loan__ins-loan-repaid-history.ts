...
export const command = 'ins-loan-repaid-history'
export const describe = "Get Repaid History"
...
const innerHandler = createHandler({
  ...
  mapArgs: (argv) => ({
    method: 'GET',
    path: '/v5/ins-loan/repaid-history',
    query: filterDefined({ startTime: argv['start-time'], endTime: argv['end-time'], limit: argv['limit'] }),

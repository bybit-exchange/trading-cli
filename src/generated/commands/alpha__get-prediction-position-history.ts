...
export const command = 'get-prediction-position-history'
export const describe = "Get user's historical closed prediction market positions"
...
export const handler = async (argv: any) => {
  ...
  checkConfirm(argv, {
    operation: 'alpha get-prediction-position-history',
    method: 'POST',
    path: '/v5/alpha/prediction/position-history',
    params: argv,
  })

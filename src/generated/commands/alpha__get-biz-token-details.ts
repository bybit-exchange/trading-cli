...
export const command = 'get-biz-token-details'
export const describe = "Get token project details including description, social links, risk flag, and order limits"
...
export const handler = async (argv: any) => {
  ...
  checkConfirm(argv, {
    operation: 'alpha get-biz-token-details',
    method: 'POST',
    path: '/v5/alpha/trade/biz-token-details',
    params: argv,
  })

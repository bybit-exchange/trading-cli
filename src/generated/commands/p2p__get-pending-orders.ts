...
export const command = 'get-pending-orders'
export const describe = "Get Pending Orders"
...
const innerHandler = createHandler({
  ...
  mapArgs: (argv) => ({
    ...
    body: { status: argv['status'], beginTime: argv['begin-time'], endTime: argv['end-time'], tokenId: argv['token-id'], side: argv['side'], page: argv['page'], size: argv['size'] },
  }),
})
...
export const handler = async (argv: any) => {
  ...
  checkConfirm(argv, {
    operation: 'p2p get-pending-orders',
    method: 'POST',
    path: '/v5/p2p/order/pending/simplifyList',
    params: argv,
  })

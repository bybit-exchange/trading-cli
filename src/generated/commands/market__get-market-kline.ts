...
export const command = 'get-market-kline'
export const describe = "Get Kline"
...
export const jsonSchema = {
  ...
  properties: {
    ...
    'symbol': {
      type: 'string',
      description: "Trading pair symbol in uppercase, e.g. `BTCUSDT`, `BTCUSD`",
...
export const builder = (yargs: any) => yargs
  ...
  .option('symbol', { type: 'string', demandOption: true, describe: "Trading pair symbol in uppercase, e.g. `BTCUSDT`, `BTCUSD`" })

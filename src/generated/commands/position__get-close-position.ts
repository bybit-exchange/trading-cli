...
export const command = 'get-close-position'
export const describe = "Get closed option position records"
...
export const jsonSchema = {
  ...
  properties: {
    ...
    'symbol': {
      type: 'string',
      description: "Option contract name.",
      
    },
    'start-time': {
      type: 'integer',
      description: "Start timestamp in milliseconds. Defaults to 24 hours ago if both times omitted.",
...
export const builder = (yargs: any) => yargs
  ...
  .option('symbol', { type: 'string', describe: "Option contract name." })
  .option('start-time', { type: 'number', describe: "Start timestamp in milliseconds. Defaults to 24 hours ago if both times omitted." })

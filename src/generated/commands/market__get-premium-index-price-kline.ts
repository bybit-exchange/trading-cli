...
export const command = 'get-premium-index-price-kline'
export const describe = "Get Premium Index Price Kline"
...
export const builder = (yargs: any) => yargs
  .option('category', { type: 'string', choices: ['linear'], describe: "Product type. Only `linear` is supported." })

...
export const command = 'confirm-new-risk-limit'
export const describe = "Confirm new risk limit to remove reduce-only restriction"
...
const innerHandler = createHandler({
  ...
  mapArgs: (argv) => ({
    ...
    body: { category: argv['category'], symbol: argv['symbol'] },
  }),
})
...
export const handler = async (argv: any) => {
  ...
  checkConfirm(argv, {
    operation: 'position confirm-new-risk-limit',
    method: 'POST',
    path: '/v5/position/confirm-pending-mmr',
    params: argv,
  })

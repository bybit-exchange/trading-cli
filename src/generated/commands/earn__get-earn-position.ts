...
export const command = 'get-earn-position'
export const describe = "Get Staked Position"
...
export const builder = (yargs: any) => yargs
  ...
  .option('coin', { type: 'string', describe: "Coin" })
...
const innerHandler = createHandler({
  ...
  mapArgs: (argv) => ({
    method: 'GET',
    path: '/v5/earn/position',
    query: filterDefined({ category: argv['category'], productId: argv['product-id'], coin: argv['coin'] }),
